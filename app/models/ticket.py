...
class Ticket(Base):
    ...
    # How far this ticket has climbed a matching EscalationRule's tier ladder
    # (0 = not escalated). Prevents the same tier firing again on every hourly
    # check, and resets to 0 on reopen — see escalation_service.py.
